...
public sealed class CollectibleCardGameCoordinator : HiroCoordinator
{
    ...
    protected override Task<Systems> CreateSystemsAsync()
    {
        ...
        var systems = new Systems("CollectibleCardGameSystems", monitor, logger);
    ...
    protected override async void SystemsInitializeCompleted()
    {
        ...
        var economySystem = Systems.GetSystem<EconomySystem>();
        var collectibleCardSystem = Systems.GetSystem<CollectibleCardSystem>();
        await _cardManager.InitAsync(economySystem, collectibleCardSystem);
    }
