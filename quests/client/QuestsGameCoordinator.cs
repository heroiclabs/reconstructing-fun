...
public sealed class QuestsGameCoordinator : HiroCoordinator
{
    ...
    protected override async void SystemsInitializeCompleted()
    {
        ...
        var questsManager = GameObject.FindWithTag("QuestsManager").GetComponent<QuestsManager>();
        await questsManager.InitAsync();
    }
