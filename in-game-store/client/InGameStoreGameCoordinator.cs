...
public sealed class InGameStoreGameCoordinator : HiroCoordinator
{
    ...
    protected override Task<Systems> CreateSystemsAsync()
    {
        ...
        var systems = new Systems("GameSystems", monitor, logger);
    ...
    protected override async void SystemsInitializeCompleted()
    {
        ...
        var inGameStoreManager = GameObject.FindWithTag("InGameStoreManager").GetComponent<InGameStoreManager>();
        await inGameStoreManager.InitAsync();
    }
