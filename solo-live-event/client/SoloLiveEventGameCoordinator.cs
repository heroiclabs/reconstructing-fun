...
public sealed class SoloLiveEventGameCoordinator : HiroCoordinator
{
    ...
    [SerializeField]
    private SoloLiveEventManager _soloLiveEventManager;
    ...
    protected override async void SystemsInitializeCompleted()
    {
        ...
        await _soloLiveEventManager.InitAsync();
    }
